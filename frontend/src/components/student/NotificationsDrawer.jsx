...
const NotificationsDrawer = ({ open, onClose, onUnreadChange }) => {
      ...
      >
          ...
          {notifications.map(n => {
            ...
            return (
              <div
                ...
                className={`flex items-start gap-3 p-4 transition cursor-pointer hover:bg-gray-50 ${!n.read ? 'bg-indigo-50/40' : ''}`}
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    {/* Unread dot — disappears when notification is clicked */}
        ...
        <div className="p-4 border-t border-gray-100">
          <button
            ...
            className="w-full py-2.5 text-sm font-medium text-indigo-600 hover:bg-indigo-50 rounded-xl transition disabled:opacity-40 disabled:cursor-not-allowed"
          >
