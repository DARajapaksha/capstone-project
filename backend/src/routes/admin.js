...
const { adminLogin, getAllVerifications, updateVerificationStatus, updateAdminProfile, getAllStudents, getAllAudits, getAllVerifiers, updateStudentVerificationStatus } = require('../controllers/adminController');
